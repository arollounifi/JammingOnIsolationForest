...
def runTestsInPaperOrder(classifierType, windowSize=None):
    ...
    #tcl.increasingMetricParameterTest(Parameters.ALTERNATING_PERIODIC_JAMMING, Parameters.MAX_SAMPLES_ID, Parameters.START_MAX_SAMPLES, Parameters.END_MAX_SAMPLES, Parameters.STEP_SIZE_MAX_SAMPLES, True, True)
    #tcl.increasingMetricParameterTest(Parameters.ALTERNATING_PERIODIC_JAMMING, Parameters.N_ESTIMATORS_ID, Parameters.START_ESTIMATORS, Parameters.END_ESTIMATORS, Parameters.STEP_SIZE_ESTIMATORS, True, True)
