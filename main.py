...
def runTestsInPaperOrder(classifierType, windowSize=None):
    ...
    #tcl.increasingMetricParameterTest(Parameters.PERIODIC_JAMMING, Parameters.MAX_SAMPLES_ID, Parameters.START_MAX_SAMPLES, Parameters.END_MAX_SAMPLES, Parameters.STEP_SIZE_MAX_SAMPLES, True, True)
    ...
    #tcl.increasingMetricParameterTest(Parameters.PERIODIC_JAMMING, Parameters.CONTAMINATION_ID, Parameters.START_CONTAMINATION, Parameters.END_CONTAMINATION, Parameters.STEP_SIZE_CONTAMINATION, True, True)
    #tcl.runMultipleTestsAndCalculateAverage(Parameters.PERIODIC_JAMMING, 10, True, False)
